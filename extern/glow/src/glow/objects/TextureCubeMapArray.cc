...
static GLOW_THREADLOCAL TextureCubeMapArray::BoundTextureCubeMapArray *sCurrentTextureCubeMapArray = nullptr;

TextureCubeMapArray::BoundTextureCubeMapArray *TextureCubeMapArray::getCurrentTexture()
{
    return sCurrentTextureCubeMapArray;
}
...
{
    GLOW_RUNTIME_ASSERT(sCurrentTextureCubeMapArray == this, "Currently bound FBO does NOT match represented Texture " << to_string(texture), return false);
    return true;
}
...
void TextureCubeMapArray::BoundTextureCubeMapArray::setBorderColor(tg::color4 const& color)
{
    if (!isCurrent())
        return;
    checkValidGLOW();
...
TextureCubeMapArray::BoundTextureCubeMapArray::BoundTextureCubeMapArray (TextureCubeMapArray *texture) : texture(texture)
{
    ...
    previousTexturePtr = sCurrentTextureCubeMapArray;
    sCurrentTextureCubeMapArray = this;
}
...
TextureCubeMapArray::BoundTextureCubeMapArray::~BoundTextureCubeMapArray ()
{
    if (previousTexture != -1) // if valid
    {
        ...
        sCurrentTextureCubeMapArray = previousTexturePtr;
    }
}
