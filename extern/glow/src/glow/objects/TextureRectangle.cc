...
static GLOW_THREADLOCAL TextureRectangle::BoundTextureRectangle *sCurrentTextureRectangle = nullptr;

TextureRectangle::BoundTextureRectangle *TextureRectangle::getCurrentTexture()
{
    return sCurrentTextureRectangle;
}
...
{
    GLOW_RUNTIME_ASSERT(sCurrentTextureRectangle == this, "Currently bound FBO does NOT match represented Texture " << to_string(texture), return false);
    return true;
}
...
void TextureRectangle::BoundTextureRectangle::setBorderColor(tg::color4 const& color)
{
    if (!isCurrent())
        return;
    checkValidGLOW();
...
TextureRectangle::BoundTextureRectangle::BoundTextureRectangle (TextureRectangle *texture) : texture(texture)
{
    ...
    previousTexturePtr = sCurrentTextureRectangle;
    sCurrentTextureRectangle = this;
}
...
TextureRectangle::BoundTextureRectangle::~BoundTextureRectangle ()
{
    if (previousTexture != -1) // if valid
    {
        ...
        sCurrentTextureRectangle = previousTexturePtr;
    }
}
